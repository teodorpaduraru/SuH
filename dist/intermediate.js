 ...
 * Heroes Quiz
 * 
 * To change the JSON with the questions just change the fetched URL
 * or run the project by fetching the questions in the `data` folder
 * (in this case serve the project with a local server to avoid CORS
 * errors).
 */
const e = "./heroes-quiz-questions.json";

function t(e, t = 1) { return 1 === t && ([e, t] = [t, e]), Math.floor((t - e + 1) * Math.random()) + e }
function s(e) { for (let s = e.length; s; s--) { let o = t(s) - 1;[e[s - 1], e[o]] = [e[o], e[s - 1]] } }
fetch(e).then(e => e.json()).then(e => { o.start.addEventListener("click", () => n.start(e.questions), !1), o.response.addEventListener("click", e => n.check(e), !1) });
const o = {
    ...
    ask() {
        if (console.log("ask() invoked"), this.questions.length > 2) {
            ...
            s(e); const t = `What is ${this.question.name}'s hair colour?`;
            o.render(o.question, t), o.render(o.response, o.buttons(e))
        } else this.gameOver()
    },
    check(e) {
        console.log("check(event) invoked");
        const t = e.target.textContent, s = this.question.realName;
        t === s ? (console.log("correct"),
            o.render(o.result, "Correct!", { class: "correct" }),
            this.score++, o.render(o.score, this.score)) : (console.log("wrong"), o.render(o.result, `Wrong! The correct answer was ${s}`, { class: "wrong" })),
            o.show(o.result),
            this.ask()
    },
    gameOver() {
