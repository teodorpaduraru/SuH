                ...
                <main class="quiz_container" style="color: gold">
                    <form action="submission.html" method="POST">
                        ...
                        <section class="buttons">
                            ...
                            <a class="buton1" style="color: floralwhite" href="<?php echo URLROOT; ?>/games/beginner"><input type="button" value="Începător"></a>
                            &nbsp;&nbsp;
                            <a class="buton2" style="color: floralwhite" href="<?php echo URLROOT; ?>/games/intermediate"><input type="button" value="Intermediar"></a>
                            &nbsp;&nbsp;
                            <a class="buton3" style="color: floralwhite" href="<?php echo URLROOT; ?>/games/expert"><input type="button" value="Avansat"></a>
                            <p>&nbsp;</p>
                        </section>
                    </form>
                </main>
