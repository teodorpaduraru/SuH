    ...
    n = {
        ...
        ask() {
            if (console.log("ask() invoked"), this.questions.length > 2) {
                ...
                const e = [this.questions[0].hairColour, this.questions[1].hairColour, this.question.hairColour];
                s(e);
                const t = `What is ${this.question.name}'s hair colour?`;
        ...
        check(e) {
            ...
            const t = e.target.textContent,
                s = this.question.hairColour;
            t === s ? (console.log("correct"),
                o.render(o.result, "Correct!", {
                    class: "correct"
                }),
                this.score = this.score + 4, o.render(o.score, this.score)) : (console.log("wrong"), o.render(o.result, `Wrong! The correct answer was ${s}`, {
                    class: "wrong"
                })),
                o.show(o.result),
                this.ask()
